...
export const adaptiveScreeningInfo = {
  initial: {
    ...
    description:
      'Wir starten mit 4 kurzen Fragen (PHQ-2 & GAD-2). Bei Bedarf folgen detailliertere Fragen.',
  },
  expanding: {
    title: 'Detaillierte Einschätzung',
    description:
      'Basierend auf deinen bisherigen Antworten stellen wir jetzt weitere Fragen für eine präzisere Einschätzung.',
  },
  minimal: {
    title: 'Geringe Belastung erkannt',
    description:
      'Deine Antworten deuten auf minimale Symptome hin. Weitere Fragen sind nicht notwendig.',
  },
};
