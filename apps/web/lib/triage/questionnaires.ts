...
export const phq9Questions: QuestionnaireQuestion[] = [
  {
    ...
    helpText: 'Haben Sie das Gefühl, dass Aktivitäten, die Ihnen früher Freude bereitet haben, nicht mehr interessant sind?',
  ...
  },
  {
    ...
    helpText: 'Fühlen Sie sich gedrückt, traurig oder haben das Gefühl, dass sich nichts mehr bessern wird?',
  ...
  },
  {
    ...
    scientificContext: 'Energiemangel kann die Ausführung alltäglicher Aufgaben deutlich erschweren.',
  },
  {
    id: 'phq9_5',
  ...
  },
  {
    ...
    scientificContext: 'Niedriges Selbstwertgefühl und Schuldgefühle sind kognitive Symptome der Depression.',
  },
  {
    id: 'phq9_7',
    ...
    scientificContext: 'Konzentrationsprobleme beeinträchtigen oft die Arbeits- und Alltagsfähigkeit.',
  },
  {
    id: 'phq9_8',
  ...
  },
  {
    ...
    helpText: 'Dies ist eine sehr wichtige Frage. Bei Ja-Antworten werden sofort Hilfsressourcen angezeigt.',
...
export const gad7Questions: QuestionnaireQuestion[] = [
  ...
  },
  {
    ...
    scientificContext: 'Angst vor zukünftigen negativen Ereignissen ist zentral bei Angststörungen.',
  },
]
