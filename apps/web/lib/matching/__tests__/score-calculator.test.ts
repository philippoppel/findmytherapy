...
describe('calculateMatchScore', () => {
  ...
  describe('score breakdown', () => {
    ...
    it('should have correct weights summing to 1', () => {
      ...
      const totalWeight = Object.values(result.components).reduce((sum, c) => sum + c.weight, 0);
    ...
    it('should calculate contribution correctly', () => {
      ...
      for (const component of Object.values(result.components)) {
        expect(component.contribution).toBeCloseTo(component.score * component.weight, 4);
      }
    });
    ...
    it('should reward higher profile quality', () => {
      ...
      expect(high.components.profileQuality.score).toBeGreaterThan(
        low.components.profileQuality.score,
      );
