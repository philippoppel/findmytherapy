 ...
 */
export const NEGATION_WORDS = ['nicht', 'kein', 'keine', 'niemals', 'nie', 'nichts', 'niemand'];
...
export const KEYWORD_PATTERNS: KeywordPattern[] = [
  // ===== AKUTE KRISE (höchste Priorität) =====
  {
    keywords: [
      ...
      'wäre besser tot',
      'familie ohne mich besser',
      'familie wäre ohne mich besser',
      'alle ohne mich besser',
      'denke ans sterben',
      'wie stirbt man',
      'wie viele tabletten',
      'überdosis',
...
export const RESPONSE_TEMPLATES: ResponseTemplate[] = [
  ...
  // ===== DEPRESSION =====
  {
    ...
    followUp:
      'Eine wissenschaftlich validierte Ersteinschätzung (PHQ-9) kann in 2 Minuten zeigen, wie ausgeprägt die depressiven Symptome sind. Das hilft dir und Fachpersonen einzuschätzen, welche Unterstützung jetzt am sinnvollsten ist.\n\n💡 Falls es akut schlimmer wird: Telefonseelsorge 142 (24/7, kostenlos, anonym)',
  ...
  },
  {
    ...
    followUp:
      'Wenn die Traurigkeit länger anhält, kann eine Einschätzung helfen zu verstehen, was dahinter steckt.',
    suggestedAction: 'take_assessment',
  },
  ...
  // ===== ANGST =====
  {
    ...
    followUp:
      'Der GAD-7-Fragebogen (Generalized Anxiety Disorder) ist ein wissenschaftlich validierter Test, der in 2 Minuten zeigt, wie stark deine Angstsymptome sind. Das Ergebnis hilft dir und Therapeut:innen, die richtige Behandlung zu finden.\n\n💡 Akut-Tipp bei Panik: 4-7-8-Atmung (4 Sekunden einatmen, 7 Sekunden halten, 8 Sekunden ausatmen)',
    suggestedAction: 'take_assessment',
  },
  {
    category: 'worry',
    ...
    followUp:
      'Ein kurzer Test könnte zeigen, ob dahinter eine Angststörung steckt oder was sonst helfen würde.',
    suggestedAction: 'take_assessment',
  },
  ...
  // ===== STRESS & BURNOUT =====
  {
    ...
    followUp:
      "Dauerstress kann zu Depression oder Angst führen. Lass uns mit einem Test schauen, wie's dir wirklich geht.",
    suggestedAction: 'take_assessment',
  },
  {
    category: 'burnout',
    ...
    followUp:
      'Eine Einschätzung kann zeigen, ob zusätzlich Depression oder Angst eine Rolle spielt – das kommt bei Burnout oft vor und braucht dann spezifische Behandlung.\n\n💡 Erste Hilfe: Schreibe auf, was dir Energie raubt und was dir Energie gibt. Das hilft, Prioritäten neu zu setzen.',
    suggestedAction: 'take_assessment',
  },
  ...
  // ===== SCHLAF =====
  {
    ...
    followUp:
      'Schlafstörungen sind oft ein Symptom – der PHQ-9 und GAD-7 Test kann zeigen, ob Depression oder Angst eine Rolle spielt.\n\n💡 Sofort-Hilfe: Feste Aufsteh-Zeit (auch am Wochenende) stabilisiert den Rhythmus besser als feste Schlafens-Zeit.',
    suggestedAction: 'take_assessment',
  },
  ...
  // ===== EINSAMKEIT & BEZIEHUNGEN =====
  {
    ...
    followUp:
      'Ein Test kann zeigen, ob die Einsamkeit bereits zu Depression geführt hat. Das ist wichtig, weil Depression es noch schwerer macht, auf Menschen zuzugehen – ein Teufelskreis, den man durchbrechen sollte.',
    suggestedAction: 'take_assessment',
  },
  {
    category: 'relationship',
    ...
    followUp:
      "Manchmal hilft's, erst mal für sich selbst Klarheit zu gewinnen. Ein Test kann zeigen, wie sehr dich das belastet.",
    suggestedAction: 'take_assessment',
  },
  ...
  // ===== SELBSTWERT =====
  {
    ...
    followUp:
      'Der PHQ-9 Test misst auch Selbstwertgefühl und Schuldgefühle. Das Ergebnis hilft einzuschätzen, wie stark die Depression ist und ob Therapie jetzt wichtig wäre.\n\n💡 Übung: Sprich mit dir selbst so, wie du mit deinem besten Freund sprechen würdest – freundlich, verständnisvoll, mitfühlend.',
    suggestedAction: 'take_assessment',
  },
  ...
  // ===== ARBEIT =====
  {
    ...
    followUp:
      'Wenn Arbeit zu Schlafstörungen oder schlechter Stimmung führt, ist das ein Warnsignal. Ein Test kann helfen.',
    suggestedAction: 'take_assessment',
  },
  ...
  // ===== HILFE SUCHEN =====
  {
    ...
    followUp:
      'Eine Ersteinschätzung kann helfen rauszufinden, welche Art von Unterstützung für dich passt.',
    suggestedAction: 'take_assessment',
  },
  {
    category: 'assessment_inquiry',
    ...
    followUp:
      'Nach dem Test siehst du Empfehlungen im Dashboard und Buttons zu passenden Therapeut:innen (/therapists) oder Programmen.',
    suggestedAction: 'take_assessment',
  },
  {
    category: 'therapy_inquiry',
    ...
    followUp:
      'Klick einfach auf "Ersteinschätzung" oder direkt /triage, dann führen wir dich zum Therapeut:innen-Verzeichnis mit konkreten Vorschlägen.',
    suggestedAction: 'take_assessment',
  },
