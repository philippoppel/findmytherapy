    ...
    <div className="bg-surface">
      <section className="relative overflow-hidden py-16">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -top-36 right-[-6rem] h-96 w-96 rounded-full bg-secondary-200/30 blur-3xl" />
          <div className="absolute bottom-[-8rem] left-[-4rem] h-80 w-80 rounded-full bg-primary-200/30 blur-3xl" />
        </div>
        ...
        <div className="relative mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 rounded-3xl border border-divider bg-white/90 p-6 shadow-lg shadow-primary/10 backdrop-blur">
            ...
            <div className="mt-6 rounded-2xl border border-primary/20 bg-primary/5 px-5 py-4 text-sm text-primary-900">
