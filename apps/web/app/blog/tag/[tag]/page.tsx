  ...
  const heroStats = [
    ...
    { label: 'Betroffene Kategorien', value: String(tagCategories.length) },
    {
      ...
      value: dateFormatter.format(
        tagPosts.map((post) => new Date(post.publishedAt)).sort((a, b) => b.getTime() - a.getTime())[0],
      ),
    },
  ]
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-14 px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="space-y-4 text-center sm:text-left">
              ...
              <p className="mx-auto max-w-3xl text-lg text-white/90 sm:mx-0">
                Wir verbinden Learnings aus Produkt, Forschung und therapeutischer Praxis. Alle Artikel, die sich auf diesen Tag beziehen, findest du hier.
              </p>
            </div>
        ...
        <section aria-labelledby="all-tags" className="space-y-6">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Link href="/blog" className="inline-flex items-center gap-2 text-sm font-semibold text-primary-900">
        ...
        >
          ...
          <div className="relative z-10 grid gap-8 lg:grid-cols-2">
            <div className="space-y-4">
              <p className="text-xs font-semibold uppercase tracking-[0.4em] text-white/80">Deine Fragen</p>
              <h2 id="tag-form" className="text-3xl font-semibold leading-tight">
                Welches Update zu #{tagName} fehlt dir?
              </h2>
              <p className="text-sm text-white/90">
                Ob Interviewpartner:in, Datenpunkt oder Produktfunktion – sag uns, was wir beleuchten sollen. Wir melden uns mit einer persönlichen Antwort.
              </p>
            </div>
