...
describe('TherapistComparison', () => {
  ...
  describe('Edge Cases', () => {
    it('should handle therapist without rating', () => {
      const therapistsWithoutRating = [
        { ...mockTherapists[0], rating: 0, reviews: 0 },
      ]
    ...
    it('should handle therapist without experience', () => {
      const therapistsWithoutExperience = [
        { ...mockTherapists[0], yearsExperience: undefined },
      ]

      render(<TherapistComparison therapists={therapistsWithoutExperience as any} onClose={mockOnClose} />)
  ...
  describe('Modal Styling', () => {
    it('should have modal overlay', () => {
      const { container } = render(<TherapistComparison therapists={mockTherapists} onClose={mockOnClose} />)
