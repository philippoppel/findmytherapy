...
const mockTherapist = {
  ...
  highlights: [
    'Online verfügbar',
    'Hybrid angeboten',
    'Erfahrung mit erhöhtem Unterstützungsbedarf',
  ],
...
describe('TherapistCard', () => {
  ...
  describe('Selection Functionality', () => {
    ...
    it('should show selected state when isSelected is true', () => {
      ...
      expect(
        screen.getByRole('button', { name: /zum vergleich hinzugefügt/i }),
      ).toBeInTheDocument();
    });
    ...
    it('should NOT render selection button when onSelect is not provided', () => {
      ...
      expect(
        screen.queryByRole('button', { name: /zur gegenüberstellung/i }),
