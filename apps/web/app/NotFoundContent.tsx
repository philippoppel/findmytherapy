    ...
    <div className="min-h-screen bg-gradient-to-b from-primary-950/5 via-primary-950/5 to-primary-950/5 px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <div className="mt-16 rounded-3xl border border-primary-200/60 bg-gradient-to-br from-primary-50 via-primary-100/50 to-white p-8 shadow-xl shadow-primary-900/10">
          <h3 className="text-lg font-bold text-gray-900">{t('notFound.popularPages')}</h3>
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
            {FEATURES.ASSESSMENT && (
              ...
              >
                ...
                <div>
                  <p className="font-semibold text-gray-900">{t('notFound.assessment')}</p>
                  <p className="text-sm text-gray-600">{t('notFound.freeTest')}</p>
                </div>
              </Link>
            )}
            ...
            >
              ...
              <div>
                <p className="font-semibold text-gray-900">{t('notFound.contact')}</p>
                <p className="text-sm text-gray-600">{t('notFound.reachCareTeam')}</p>
              </div>
            </Link>
          </div>
        </div>
