                      ...
                      {profile.rating && (
                        <div className="flex items-center gap-2 px-3 py-1.5 bg-white/10 backdrop-blur-sm rounded-lg">
                          ...
                          <span className="text-white/70">
                            ({profile.reviewCount ?? 0} Bewertungen)
                          </span>
                        </div>
                      )}
                  ...
                  <div className="space-y-4">
                    <div className="text-sm text-white/90 space-y-2">
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <span>
                          {formatCurrencyRange(profile.priceMin, profile.priceMax)} pro Einheit
                        </span>
                      </div>
                    </div>
                    <Button
                    ...
                    <p className="text-xs text-white/70 text-center">Erstgespräch unverbindlich</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <dl className="space-y-4 text-sm">
                  ...
                  <div>
                    ...
                    <dd className="text-slate-900">
                      {profile.responseTime ?? 'Innerhalb von 48 Stunden'}
                    </dd>
                  </div>
