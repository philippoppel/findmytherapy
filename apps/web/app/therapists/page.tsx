...
import { demoTherapists } from '@mental-health/db'
...
export default function TherapistsPage() {
  const therapists: TherapistCard[] = demoTherapists.map((therapist) => ({
    ...
    <div className="bg-surface">
      <section className="relative overflow-hidden bg-gradient-to-b from-primary-50 via-surface-1 to-surface-1 py-20">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -top-32 right-[-4rem] h-80 w-80 rounded-full bg-primary-200/40 blur-3xl" />
          <div className="absolute bottom-[-6rem] left-[-2rem] h-72 w-72 rounded-full bg-secondary-200/30 blur-3xl" />
        </div>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-6 rounded-3xl border border-divider bg-white/80 p-8 shadow-md shadow-primary/10 backdrop-blur">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div>
                <h2 className="text-left text-3xl font-semibold text-neutral-900">
                  Demo: Ausgewählte Klarthera-Therapeut:innen
                </h2>
