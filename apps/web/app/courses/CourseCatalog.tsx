          ...
          >
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <h3 className="text-2xl font-semibold text-default">{course.title}</h3>
              ...
              <dl className="grid grid-cols-1 gap-3 rounded-xl border border-divider bg-surface-1/90 p-4 text-sm text-muted">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <dt className="font-medium text-default">Dauer</dt>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <dt className="font-medium text-default">Intensität</dt>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <dt className="font-medium text-default">Format</dt>
                    <dd>{course.format}</dd>
                  </div>
                </div>
              </dl>
              <div className="rounded-xl border border-divider bg-white/70 p-4 text-sm text-muted">
                <p className="font-medium text-default">Das erwartet dich</p>
            ...
            <div className="mt-6 space-y-4 border-t border-divider pt-4">
              <div className="flex items-center justify-between text-sm text-default">
                ...
                <span className="text-xs text-muted">{course.lessons} Lektionen insgesamt</span>
              </div>
              ...
              {isExpanded && (
                <div
                  ...
                  className="rounded-2xl border border-primary/30 bg-primary/10 p-4 text-sm leading-relaxed text-primary dark:border-primary/50 dark:bg-primary/20"
                >
                  <p className="font-medium text-primary">So funktioniert das Programm</p>
