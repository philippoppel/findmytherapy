const clauses = [
  ...
  },
  {
    ...
    body:
      'Digitale Programme werden über Stripe abgerechnet. Honorare für Sitzungen werden unter Berücksichtigung der jeweiligen Therapeutenvereinbarungen eingezogen.',
  },
  {
    title: '4. Haftung',
    body:
      'Wir haften nur für Schäden, die auf grobe Fahrlässigkeit oder Vorsatz zurückzuführen sind. Dies gilt nicht für Schäden an Leben, Körper oder Gesundheit.',
  },
];
