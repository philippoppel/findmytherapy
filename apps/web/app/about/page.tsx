    ...
    <div className="bg-surface">
      <section className="relative overflow-hidden bg-gradient-to-b from-primary-50 via-surface-1 to-surface-1 py-20">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -top-24 right-[-6rem] h-80 w-80 rounded-full bg-primary-200/35 blur-3xl" />
          <div className="absolute bottom-[-10rem] left-[-2rem] h-80 w-80 rounded-full bg-secondary-200/30 blur-3xl" />
        </div>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="space-y-8 rounded-3xl border border-divider bg-white/85 p-8 shadow-md shadow-primary/10 backdrop-blur">
              <h2 className="text-3xl font-semibold text-neutral-900">Unsere Herangehensweise</h2>
            ...
            <aside className="flex flex-col justify-between rounded-3xl border border-divider bg-primary-600 px-6 py-8 text-primary-foreground shadow-[0_25px_55px_-35px_rgb(var(--color-primary-950))]">
              <div className="space-y-4">
                <h3 className="text-2xl font-semibold">Klarthera in Zahlen (Demo)</h3>
              ...
              <p className="rounded-2xl bg-primary-500/40 p-4 text-sm leading-relaxed">
                Wir teilen diese Demo-Zahlen, um zu zeigen, wie Klarthera Wirkung sichtbar macht. Für Präsentationen oder Sales kann der Abschnitt jederzeit angepasst werden.
              </p>
            </aside>
          </div>
        </div>
      ...
      <section className="bg-gradient-to-r from-secondary-50 via-surface-1 to-primary-50 py-16">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl space-y-3">
              <h2 className="text-3xl font-semibold text-neutral-900">Team Klarthera (Demo)</h2>
              <p className="text-base text-muted">
                Interdisziplinär aufgestellt – mit klaren Rollen zwischen therapeutischer Expertise, Produktentwicklung und Care-Team.
              </p>
            </div>
            <span className="inline-flex items-center rounded-full border border-divider bg-white/70 px-4 py-2 text-sm text-muted">
              <Sparkles className="mr-2 h-4 w-4 text-primary" /> Demodaten - für Präsentationen anpassbar
            </span>
          </div>

          <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2">
            {teamMembers.map((member) => (
              <div key={member.name} className="rounded-3xl border border-divider bg-white/85 p-6 shadow-sm shadow-primary/10">
