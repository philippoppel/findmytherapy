      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-neutral-50 px-4">
          <div className="max-w-md w-full rounded-3xl border border-divider bg-white p-8 shadow-lg text-center">
            ...
            <h1 className="text-2xl font-semibold text-default mb-2">Etwas ist schiefgelaufen</h1>
            <p className="text-sm text-muted mb-6">
              Es tut uns leid, aber ein unerwarteter Fehler ist aufgetreten. Bitte laden Sie die
              Seite neu oder kontaktieren Sie unseren Support.
            </p>
