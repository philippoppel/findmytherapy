        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-8">
          ...
          <div className="order-1 space-y-6 lg:order-2">
            ...
            <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
              ...
              <dl>
                <dt className="mt-6 flex items-start gap-3 text-neutral-900 first:mt-0">
                  ...
                  <span className="font-medium">{t('auth.secureAndGdpr')}</span>
                </dt>
                <dd className="pl-8 pt-2 text-sm text-neutral-700">
                  {t('auth.secureAndGdprDesc')}
                </dd>

                <dt className="mt-6 flex items-start gap-3 text-neutral-900 first:mt-0">
                  <HeartHandshake className="mt-0.5 h-5 w-5 shrink-0 text-primary" aria-hidden />
                  <span className="font-medium">{t('auth.careTeamIncluded')}</span>
                </dt>
                <dd className="pl-8 pt-2 text-sm text-neutral-700">
                  {t('auth.careTeamIncludedDesc')}
                </dd>
              </dl>
            </div>
            ...
            <div className="rounded-2xl border border-primary/30 bg-primary-50/50 p-6">
              <h3 className="font-semibold text-neutral-900">{t('auth.startForFree')}</h3>
              <p className="mt-2 text-sm text-neutral-700">{t('auth.startForFreeDesc')}</p>
            </div>
          </div>
        </div>
      </div>
