    ...
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8 space-y-8">
      <header className="space-y-2">
        ...
        <p className="text-sm text-neutral-700">
          Übersicht über offene Auszahlungen und vergangene Überweisungen. Derzeit sind keine echten
          Beträge hinterlegt.
        </p>
      </header>
      ...
      <section className="rounded-2xl border border-info-200 bg-info-50 p-6 text-sm text-info-900">
        ...
        <p className="mt-2">
          Auszahlungen erfolgen regulär wöchentlich über Stripe Connect. Lade in der finalen Version
          bitte deine Konto- und Steuerdaten im Onboarding hoch, damit wir Überweisungen
          freischalten können.
        </p>
      </section>
    </div>
