...
export function MicrositePreviewButton() {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-2 px-4 py-2 bg-white border-2 border-teal-500 text-teal-700 rounded-lg text-sm font-medium hover:bg-teal-50 transition shadow-sm"
    >
