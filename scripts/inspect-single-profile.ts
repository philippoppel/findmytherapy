...
async function main() {
  ...
  try {
    ...
    const profileUrl =
      'https://www.psyonline.at/go.asp?personen_id=163111&sektion=personen&rkarte=infodetails&berufsgruppe=pth&bereich_id=9001&subbereich_id=0';
    ...
    const profileData = await page.evaluate(() => {
      ...
      data.hasAbout =
        document.body.innerText.toLowerCase().includes('über mich') ||
